...
# Reject exhausted candles
MAX_FINAL_BODY_PERCENT = 12.0

# Ideal exponential growth
IDEAL_ACCELERATION_MIN = 1.3
IDEAL_ACCELERATION_MAX = 4.0

# Reject flattening
MIN_LAST_EXPANSION = 1.12
